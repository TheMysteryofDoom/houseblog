...
driver.find_element_by_id("title").send_keys("this is my new title")
driver.find_element_by_id("content").send_keys("this is my new content")

driver.save_screenshot("blog_post_credentials_screenshot.png")

driver.find_element_by_id("post").click()

driver.save_screenshot("valid_blog_post_screenshot.png")
#This was made by Greg Marvin T. Cabrera